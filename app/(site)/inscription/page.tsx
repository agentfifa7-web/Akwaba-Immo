  ...
  return (
    <section className="mx-auto max-w-md px-5 py-20 lg:px-10 lg:py-28">
      ...
      <form onSubmit={handleSubmit} className="mt-10 border border-border bg-card p-7 lg:p-9">
        ...
        <button
          type="submit"
          className="mt-7 flex w-full items-center justify-center gap-2 bg-primary px-6 py-4 text-xs font-semibold uppercase tracking-wider text-primary-foreground transition-colors hover:bg-primary/90"
        >
